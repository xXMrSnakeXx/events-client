...
export const Header = () => {
  ...
  return (
    <>
      <header className="rounded-bl-[10px] shadow-custom-dark rounded-br-[10px] bg-main-background flex items-center justify-between py-5 px-2.5">
            ...
            <ul className="flex items-center gap-5">
              <li>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    isActive
                      ? "text-white bg-accent py-1.5 px-3 rounded-md scale-100 pointer-events-none text-medium"
