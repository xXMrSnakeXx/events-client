...
const RegisterForm = () => {
	...
	return (
          ...
          overflow-hidden
          '>
								<label htmlFor={nameId} className='
            text-[20px]
            text-white
            mb-3
            '>
              ...
              border-primary'
								/>
								<ErrorMessage name="fullname" component="p" className='text-[10px] text-error'/>
            ...
            '>
              ...
              border-primary'
								/>
								<ErrorMessage name="email" component="p" className='text-[10px] text-error'/>
								<label htmlFor={birthdayId} className='
            text-[20px]
            text-white
            mb-3
            '>
              ...
              border-primary'
								...
								<ErrorMessage name="birthday" component="p" className='text-[10px] text-error'/>
            ...
            '>
								...
								<div className='w-[450px] flex items-center justify-between mt-[25px]'>
									...
									<Field
											...
											className='w-5 h-5 cursor-pointer'
									/>
									<ErrorMessage name="source" component="p" className='text-[10px] text-error'/>
								</div>
